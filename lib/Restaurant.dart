...
import 'package:foodapptwo/widgets/page3_viewcard.dart';
import 'package:foodapptwo/widgets/page3_restaurant_card.dart';
                ...
                width: 400,
                    ...
                    decoration:
                        ...
                        child: ListView.builder(physics: NeverScrollableScrollPhysics(),scrollDirection: Axis.vertical,itemCount: foodimages.length,itemBuilder: ((context, index) {
                          return PageRestaurantCard(foodimg: foodimages[index], foodtext: foodtexts[index], foodrank: foodranks[index], foodprice: foodprices[index]);
                        })),
              ),
            ),
            Positioned(left: 30,bottom:7,
            child: PageCard())
