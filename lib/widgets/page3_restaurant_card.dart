...
class PageRestaurantCard extends StatefulWidget {
  final String foodimg;
  final String foodtext;
  final String foodrank;
  final String foodprice;
  
  const PageRestaurantCard({super.key, required this.foodimg, required this.foodtext, required this.foodrank, required this.foodprice,});

  @override
  State<PageRestaurantCard> createState() => _PageRestaurantCardState();
}

class _PageRestaurantCardState extends State<PageRestaurantCard> {
  @override
